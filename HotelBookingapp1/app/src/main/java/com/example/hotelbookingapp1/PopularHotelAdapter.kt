...
class PopularHotelAdapter(private var hotels: MutableList<Hotel>) : RecyclerView.Adapter<PopularHotelAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        // Make ivFavorite nullable to handle cases where it might not exist in the layout
        val ivFavorite: ImageView? = itemView.findViewById(R.id.ivFavorite)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_hotel_vertical, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Only handle favorites if the favorite button exists
        holder.ivFavorite?.let { favoriteButton ->
                ...
                try {
                    ...
                    if (currentUser != null) {
                        ...
                        if (success) {
                            ...
                            favoriteButton.announceForAccessibility(announcement)
                        }
                    }
                } catch (e: Exception) {
                    e.printStackTrace()
